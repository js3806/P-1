...
<body>
    ...
    <div class="concert-details">
        <img src="https://tjv-s3-bucket.s3.ap-northeast-2.amazonaws.com/iu_2.png" alt="C-1 CONCERT">
        <h1>2024 IU : THE GOLDEN HOUR </h1>
        <p>장소: 엑스코 대회의장</p>
        <p>일정: 2024.05.18 ~ 2024.05.19</p>
        <p>공연시간: 120분</p>
        <p>가격: VIP₩154,000 | R₩143,000 | S₩132,000</p>
